        ...
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
                    <img src="{{ asset('images/ourteam-section/person1.jpeg') }}" alt="Tim 1" class="w-32 h-32 mx-auto rounded-full object-cover mb-6">
                ...
                {{-- Anggota 2 --}}
                <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
                    <img src="{{ asset('images/ourteam-section/person2.jpeg') }}" alt="Tim 2" class="w-32 h-32 mx-auto rounded-full object-cover mb-6">
                ...
                {{-- Anggota 3 --}}
                <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
                    <img src="{{ asset('images/ourteam-section/person3.jpeg') }}" alt="Tim 3" class="w-32 h-32 mx-auto rounded-full object-cover mb-6">
