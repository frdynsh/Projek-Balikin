        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-3">
                    {{-- Export Excel --}}
                    <a href="{{ route('admin.validasi.found-items.exportExcel') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-500 active:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                        Export Excel
                    </a>
                    
                    {{-- Export PDF --}}
                    <a href="{{ route('admin.validasi.found-items.exportPdf') }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 active:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                        Export PDF
                    </a>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <form id="delete-form-{{ $barang->id }}" 
                                              action="{{ route('admin.validasi.found-items.destroy', $barang->id) }}" 
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                        Tidak ada laporan barang temuan di arsip.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
